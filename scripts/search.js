...
var detailsUrl =
"https://maps.googleapis.com/maps/api/place/details/json?reference=" + entry.reference +
"&sensor=true&key=AIzaSyBKF60cPPzzx1Wn5z9QutliPnbBiXTN_Z0";
$("#name").html("");
$("#address").html("");
$("#phone").html("");
$("#rating").html("");
...
entry.reference + "\"> <img src=\"" + entry.icon + "\" class=\"ui-li-icon\"></img><h3>&nbsp;" + entry.name + "</h3><p><strong>&nbsp;vicinity:" +
entry.vicinity + "</strong></p></a>";
var liElem = $(document.createElement('li'));
$("#favlist").
append(liElem.html(htmlData));
...
var insertStmt = 'INSERT INTO Favorite (id,reference,name,address,phone,rating,icon,vicinity) VALUES (' + id + ',' + reference + ',' + name +
...
var url ="https://maps.googleapis.com/maps/api/place/search/json?location=-0.3935377506717727, 36.959603791193324&radius=" + radius +
"&name=" + $("#searchbox").val() + "&sensor=true&key=AIzaSyBKF60cPPzzx1Wn5z9QutliPnbBiXTN_Z0";
...
var htmlData = "<a href=\"#details\" id=\"" +
entry.reference + "\"><img src=\"" + entry.icon + "\" class=\"ui-li-icon\"></img><h3>&nbsp;" + entry.name +
